...
@pytest.mark.django_db
def test_event_delete_unauthorised_unauthenticated(
        api_client,
        user_2,
        event_created_by_user_2,
):
...
@pytest.mark.django_db
def test_event_delete_unauthorised_not_verified(
        api_client,
        user_2,
        event_created_by_user_2,
):
...
@pytest.mark.django_db
def test_event_delete_unauthorised_not_creator(
        api_client,
        user,
        event,
):
...
@pytest.mark.django_db
def test_event_delete_unauthorised_participant_not_creator(
        api_client,
        user,
        event,
):
