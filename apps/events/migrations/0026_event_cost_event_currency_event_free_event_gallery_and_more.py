...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='currency',
            field=models.CharField(choices=[('BYN', 'Belarusian ruble'), ('USD', 'United States dollar'), ('EUR', 'Euro'), ('RUB', 'Russian ruble'), ('PLN', 'Polish zloty'), ('UAH', 'Ukrainian hryvnia'), ('KZT', 'Kazakhstani tenge')], default='BYN', max_length=3),
        ),
        migrations.AddField(
            model_name='event',
            name='free',
