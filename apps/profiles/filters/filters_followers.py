...
class UserFollowersFilter(filters.FilterSet):
    ...
    username_contains = filters.CharFilter(
        lookup_expr="icontains", field_name="follower__username"
    )
    ...
    date_of_birth__gte = filters.DateFilter(
        lookup_expr="gte", field_name="follower__date_of_birth"
    )
    date_of_birth__lte = filters.DateFilter(
        lookup_expr="lte", field_name="follower__date_of_birth"
    )
