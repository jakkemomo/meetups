...
def test_in_app_notifications_preferences_patch_valid(
        api_client,
        user,
):
    # user logs in
...
@pytest.mark.django_db
def test_in_app_notifications_preferences_patch_unauthorized(
        api_client,
        user,
):
    # user gets his notifications preferences
...
@pytest.mark.django_db
def test_in_app_notifications_preferences_patch_invalid_data(
        api_client,
        user,
):
    # user logs in
